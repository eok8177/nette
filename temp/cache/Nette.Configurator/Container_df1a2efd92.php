<?php
// source: /home/www/Git/nette/app/config/config.neon 
// source: /home/www/Git/nette/app/config/config.local.neon 

class Container_df1a2efd92 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/www/Git/nette/app',
			'wwwDir' => '/home/www/Git/nette/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/www/Git/nette/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/www/Git/nette/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/www/Git/nette/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_df1a2efd92_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_df1a2efd92_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_df1a2efd92 $container)
	{
