<?php
// source: /home/www/Git/nette/app/FrontModule/../config/config.neon 
// source: /home/www/Git/nette/app/FrontModule/../config/config.local.neon 

class Container_4ff37db487 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\FrontModule\BasePresenter' => array(
				array(
					'application.1',
					'application.2',
					'application.4',
			...
			'App\FrontModule\DefaultPresenter' => array(array('application.1')),
			'App\FrontModule\SignPresenter' => array(array('application.2')),
			'App\FrontModule\ErrorPresenter' => array(array('application.3')),
			'App\FrontModule\Error4xxPresenter' => array(array('application.4')),
		...
		'services' => array(
			...
			'application.1' => 'App\FrontModule\DefaultPresenter',
			'application.2' => 'App\FrontModule\SignPresenter',
			'application.3' => 'App\FrontModule\ErrorPresenter',
			'application.4' => 'App\FrontModule\Error4xxPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/www/Git/nette/app/FrontModule',
			'wwwDir' => '/home/www/Git/nette/www/FrontModule',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/www/Git/nette/app/FrontModule/../../temp',
		));
	}
	...
	/**
	 * @return App\FrontModule\DefaultPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\FrontModule\DefaultPresenter;
	...
	/**
	 * @return App\FrontModule\SignPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\FrontModule\SignPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\FrontModule\ErrorPresenter
	 */
	public function createServiceApplication__3()
	{
		$service = new App\FrontModule\ErrorPresenter($this->getService('tracy.logger'));
		return $service;
	}


	/**
	 * @return App\FrontModule\Error4xxPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\FrontModule\Error4xxPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/www/Git/nette/app/FrontModule/../../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/www/Git/nette/app/FrontModule/../../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/www/Git/nette/app/FrontModule/../../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_4ff37db487_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/home/www/Git/nette/app/FrontModule/../../temp/cache/latte');
...
final class Container_4ff37db487_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_4ff37db487 $container)
	{
