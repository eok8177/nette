<?php
// source: /home/www/Git/nette/app/presenters/templates/Homepage/default.latte

class Template9d0b8f29d0bc26796c81cb0f0f449c21 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ad6d4be5a7', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3e22617463_content')) { function _lb3e22617463_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb738fad3268_title')) { function _lb738fad3268_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbf2e7d72c6a_scripts')) { function _lbf2e7d72c6a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb0dce070646_head')) { function _lb0dce070646_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
