<?php
// source: /home/www/Git/nette/app/FrontModule/presenters/templates/Default/Default.latte

class Templatec71127a1d54aff1c6e30d1ac2fc8601c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c48ae6e543', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbc00fc491c9_content')) { function _lbc00fc491c9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbb08eedff19_title')) { function _lbb08eedff19_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb063ce025a2_scripts')) { function _lb063ce025a2_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb709760077e_head')) { function _lb709760077e_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
