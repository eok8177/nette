<?php
// source: /home/www/Git/nette/app/presenters/templates/@layout.latte

class Template35f81eabbd1b83ef6857a9547b3ee8b6 extends Latte\Template {
function render() {
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbc0d8561432_head')) { function _lbc0d8561432_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb3b1eb40925_scripts')) { function _lb3b1eb40925_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
