<?php
// source: /home/www/Git/nette/app/FrontModule/presenters/templates/@layout.latte

class Templated8856828187c536ea9ac95a624ce6dcf extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('07b71de524', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb88d3c40be2_head')) { function _lb88d3c40be2_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb9e55664d34_scripts')) { function _lb9e55664d34_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
